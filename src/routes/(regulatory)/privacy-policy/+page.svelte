...
<p>
	At Cord G, accessible from https://cordg.com, one of our main priorities is the privacy of our
	visitors. This Privacy Policy document contains types of information that is collected and
	recorded by Cord G and how we use it.
</p>
...
<p>
	...
	with regards to the information that they shared and/or collect in Cord G. This policy is not
...
<p>
	Cord G follows a standard procedure of using log files. These files log visitors when they visit
...
<p>
	You may consult this list to find the Privacy Policy for each of the advertising partners of Cord
	G.
</p>

<p>
	Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons
	that are used in their respective advertisements and links that appear on Cord G, which are sent
...
<p>
	Note that Cord G has no access to or control over these cookies that are used by third-party
	advertisers.
</p>
...
<p>
	Cord G's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you
...
<p>
	Cord G does not knowingly collect any Personal Identifiable Information from children under the
